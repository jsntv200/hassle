...
A fork of Hassle with a couple fixes backported from the "jasoncodes branch":https://github.com/jasoncodes/hassle. 
...
This version works as a Gem for use with Rails v2.3.x
...
Add Hassle to your Gemfile

<pre>
gem "hassle", :git => "git://github.com/jsntv200/hassle.git"
</pre>
